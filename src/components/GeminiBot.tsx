...
import { Bot, X, Send, AlertTriangle, Minimize, Maximize } from 'lucide-react';
    ...
    const testApiConnection = async () => {
      try {
        ...
        if (!isConnected) {
          ...
          toast.warning('Gemini AI service is not available', {
            description: 'Using local response generation instead'
          });
        } else {
